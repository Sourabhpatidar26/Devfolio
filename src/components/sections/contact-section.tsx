...
import { Users as SectionIcon } from 'lucide-react'; // Main section icon
  ...
  return (
    <section id="contact" className="bg-secondary/50">
      <div className="container mx-auto px-4 md:px-6">
        <SectionHeading title="Get In Touch" icon={SectionIcon} subtitle="I'm open to new opportunities and collaborations. Let's connect!" />
            ...
            <Card className="shadow-xl p-6 md:p-8 h-full animate-fade-in-up">
              ...
              <div className="space-y-5">
                {contactMethods.map((method) => {
                  const IconComponent = method.iconName ? LucideIcons[method.iconName as keyof typeof LucideIcons] as LucideIcon : null;
                  return (
                    <div key={method.label} className="flex items-start">
                      {IconComponent && <IconComponent className="h-6 w-6 text-primary mr-4 mt-1 flex-shrink-0" />}
                      <div>
